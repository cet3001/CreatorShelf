...
const envSchema = z.object({
  ...
  // Supabase (paste real values in .env; leave empty to disable)
...
const BUNDLE_IDS = {
  development: 'io.creatorshelf.app.development',
  preview: 'io.creatorshelf.app.preview',
  production: 'io.creatorshelf.app',
} as const;
...
const SCHEMES = {
  development: 'creatorshelf',
  preview: 'creatorshelf.preview',
  production: 'creatorshelf',
} as const;

const NAME = 'CreatorShelf';
